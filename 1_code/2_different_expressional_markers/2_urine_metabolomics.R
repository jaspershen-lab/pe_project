...
dir.create(
  "3_data_analysis/2_different_expressional_markers/2-urine-metabolomics-data",
  recursive = TRUE,
  showWarnings = FALSE
)

setwd("3_data_analysis/2_different_expressional_markers/2-urine-metabolomics-data")
